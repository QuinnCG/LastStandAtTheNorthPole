...
namespace Quinn
{
	public static class BoundsExtensions
	{
		...
		public static Vector2 Left(this Rect bounds)
		{
			return new Vector2(bounds.center.x - bounds.size.x, bounds.center.y);
		}
		public static Vector2 Right(this Rect bounds)
		{
			return new Vector2(bounds.center.x + bounds.size.x, bounds.center.y);
		}
		public static Vector2 Top(this Rect bounds)
		{
			return new Vector2(bounds.center.x, bounds.center.y + bounds.size.y);
		}
		public static Vector2 Bottom(this Rect bounds)
		{
			return new Vector2(bounds.center.x, bounds.center.y - bounds.size.y);
		}
	}
