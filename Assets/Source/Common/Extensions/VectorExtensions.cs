...
namespace Quinn
{
	public static class Vector2Utility
	{
		...
		public static float DistanceToSquared(this Vector2 origin, Vector2 target)
		{
			return (target - origin).sqrMagnitude;
		}
		public static float SquaredDistanceTo(this Vector3 origin, Vector3 target)
		{
			return (target - origin).sqrMagnitude;
		}
		...
		{
			return v.ToAngleInRadians().ToDegrees();
		}
	}
}
